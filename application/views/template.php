  ...
  ============================-->
	...
	<section id="intro">
		<div class="intro-container wow fadeIn">
			...
			<p class="mb-2 pb-0"><span>SYNCHRONIZE EVENT ORGANIZER</span> PRESENT : </p>\
			...
			<a href="#about" class="about-btn scrollto mt-4">About The Event</a>
		</div>
	</section>
...
<div style="margin-top: 50px !important;" class="modal fade bd-example-modal-lg" id="video" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
			<video id="videoplay" height="600px" width="800px" style="background: black;" allowfullscreen>
				<source src="<?php echo base_url('assets/videos/sync.mp4') ?>" type="video/mp4" autoplay="true">
			</video>
    </div>
  </div>
</div>
	...
	<script type="text/javascript">
	 ...
	 function download()
	 {
			 document.getElementById("link").innerHTML = "<a href='#' class='venobox play-btn mt-2 text-center' data-toggle='modal' data-target='#video' data-vbtype='video' data-autoplay='true'></a><br>";
