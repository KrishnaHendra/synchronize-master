...
<div class="card col-12">
  ...
  <div class="row">
                              ...
                              <div class="card">
                                <video controls height="300px" width="300px">
                                  ...
                                  <div class="card-body">
                                      ...
                                      <a href="" class="btn btn-sm btn-block btn-light text-center" data-toggle="modal" data-target="#ubah_data" onclick="prepare_ubah('.$d->id_dj.')"><i class="fa fa-fw fa-info-circle"></i><b> Info </b>  </a>
          ...
          <button class="btn btn-block btn-info sweet-success" data-toggle="modal" data-target="#tambah_data"><i class="fa fa-fw fa-plus-circle"></i> DJ Baru</button>
          <!-- MODAL TAMBAH GS -->
          ...
          <div class="modal-dialog modal-lg" role="document">
              ...
              <div class="modal-body">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                          <textarea name="alamat" class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="street, city, "></textarea>
                          </div>
                      </div>
                      <div class="form-group row">
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-footer">
              ...
              <a href="<?= base_url('deje/delete'); ?>/<?= $d->id_dj ?>" class="btn btn-danger">Hapus</a>
            </div>
            </div>
          </div>
          </div>
