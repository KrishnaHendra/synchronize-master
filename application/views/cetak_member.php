...
<table class="tab;e table-bordered table-striped">
    <tr style="background-color: #c2c2c2;">
        ...
        <th class="text-center" style="width:">Tanggal Daftar</th>
    </tr>
    <?php $no=1; foreach($member as $m):?>
        <tr>
            <td class="text-center" style="width: 5%; height: 80px;"><?= $no++ ?></td>
            ...
            <td class="text-center" style="width: 20%;"><?= $m['tgl_lahir'] ?></td>
