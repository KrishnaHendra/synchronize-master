...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <?= $this->session->flashdata('notif'); ?>
    								...
    								<div class="table-responsive">
    									<table class="table table-hover">
    										<thead class="text-center">
    											<tr>
    												<th colspan="2">TICKET TYPE : <span class="text-danger">OH-NAIS FEST : EPISODE WAYTUBER</span>&nbsp&nbsp(Rp. 75.000)
                          ...
                          <tr>
                            <td rowspan="2"><img src="<?php echo base_url(); ?>assets/images/poster.jpg"  height="180px" width="150px" class="mt-4"></td>
                            <td colspan="2"><img src="<?php echo base_url(); ?>assets/images/syn.jpg" alt="image" height="50px" width="110px"></td>
                          </tr>
                          <tr>
                            <td colspan="2"><img src="<?php echo base_url(); ?>assets/images/barcode.png" alt="image" height="70px" width="140px"></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td colspan="2"><h4 class="text-danger ml-5"><b>TERMS & CONDITION</b></h4>
                              <ul>
                                <li></li>
                              </ul>
                            </td>
